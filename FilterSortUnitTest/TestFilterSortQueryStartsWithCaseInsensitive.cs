...
{
    public class TestFilterSortQueryStartsWithCaseInsensitive
    {
        List<DataDTO> _data;
        [SetUp]
        public void Setup()
        ...
        [Test]
        public void ValidateFilterDataStartsWithCaseInsensitiveString()
        {
            //arrange
            FilterSoftModel filter = new FilterSoftModel();
            filter.Filter = "propiedadString_=*textO";
            ...
            var dataCount = _data.Where(x => x.propiedadString.ToLower().StartsWith("textO".ToLower())).ToList();

            //assert
            Assert.AreEqual(dataCount.Count, data.Count);
        }
        [Test]
        public void ValidateFilterDataStartsWithCaseInsensitiveDate()
        {
            //arrange
            FilterSoftModel filter = new FilterSoftModel();
        ...
        [Test]
        public void ValidateFilterDataStartsWithCaseInsensitiveNumber()
        {
            //arrange
            FilterSoftModel filter = new FilterSoftModel();
        ...
        [Test]
        public void ValidateFilterDataStartsWithCaseInsensitiveBoolean()
        {
            //arrange
            FilterSoftModel filter = new FilterSoftModel();
