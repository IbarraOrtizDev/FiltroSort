...
| `double`                                 | `==`, `!=`, `>`, `<`, `>=`, `<=`                                                                                                                                                      |
| `decimal`                                | `==`, `!=`, `>`, `<`, `>=`, `<=`                                                                                                                                                      |
| `DateTime`                               | `==`, `!=`, `>`, `<`, `>=`, `<=`, `@=`.  El operador [`@=`] se creo para evaluar un contains sobre una fecha, convirtiendo la fecha a un string y este ultimo solo permite evaluar un valor, es decir que NO permite lo siguiente: propertyDate@=value1|value2                                                                                                                                                  |
| `bool`                                   | `==`, `!=`                                                                                                                                                                            |
...
Consultar elementos con or y and
```c#
